...
public final class ItemFriendBinding implements ViewBinding {
  ...
  private ItemFriendBinding(@NonNull ConstraintLayout rootView,
      @NonNull ShapeableImageView imageView, @NonNull TextView tvName,
  ...
  public static ItemFriendBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemFriendBinding((ConstraintLayout) rootView, imageView, tvName, tvNickName);
    }
