...
public final class LayoutShareBinding implements ViewBinding {
  ...
  private LayoutShareBinding(@NonNull ConstraintLayout rootView,
      @NonNull ConstraintLayout constraintLayout, @NonNull RecyclerView rvShare) {
  ...
  public static LayoutShareBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LayoutShareBinding((ConstraintLayout) rootView, constraintLayout, rvShare);
    }
